...
if($db->rows($sql) > 0) {
  ...
  $mail->AltBody = 'Hola ' . $user . ' para recuperar tu contraseña debes ir a este enlace: ' . $link . ' , si no has solicitado un cambio de contraseña omite este mensaje gracias por su atención.';
